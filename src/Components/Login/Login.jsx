...
function Login() {
    ...
    return (
        <div className='login-container'>
            ...
            <p className='login-text'>Korpem.az ailəsinə qoşulun və unikal endirimlər, yeni kolleksiyalar və fərdi təkliflərdən faydalanın</p>
            <form onSubmit={handleSubmit} className='login-form'>
                ...
                <p className='profil'>Hesabınız yoxdur? <Link to="/">Qeydiyyat</Link></p>
            </form>
        </div>
    );
}
